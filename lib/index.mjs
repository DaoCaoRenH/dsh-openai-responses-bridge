...
function assertServiceable(config) {
	for (const [route, source] of Object.entries(config.providers ?? {})) {
		...
		if (hosted?.imageGeneration?.enabled === true) throw new Error(`llm-openai-responses-bridge: provider "${route}" imageGeneration requires a verified DSH assistant-image output backend; none is available in DSH 0.1.2-alpha.1`);
